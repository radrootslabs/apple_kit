...
public actor RadrootsInMemoryBackgroundTransferStore: RadrootsBackgroundTransferStore {
    ...
    public func admissionIsActive(for identifier: RadrootsBackgroundTransferIdentifier) async throws -> Bool {
        admissions.contains(identifier)
    }
    ...
    public func compareExchangeSnapshot(
        ...
        guard snapshotsByIdentifier[desired.identifier] == expected else { return false }
        snapshotsByIdentifier[desired.identifier] = desired
        return true
    }
